/*
	...
	あ JASA RUN HEROKU BISA PC wa.me/6289652300145 BIAR BOT NYA GAK TERLALU DELAY
...
gc_wa_lu = 'https://github.com/LihhXd' 
...
await alpha.updatePresence(from, Presence.composing)
		...
		try {
					...
					pp_userb = 'https://i.ibb.co/VvTj0rT/IMG-20220112-012839.jpg'
				}
	...
	return admins
		...
		const alphaNumber = [`6289652300145@s.whatsapp.net`, `918156874290@s.whatsapp.net` , `62857101331033@s.whatsapp.net`]
...
const bugtrol = { 
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"message": `${creator}`,
						"orderTitle": `${creator}`,
						"sellerJid": "6289652300145@s.whatsapp.net",
						"token": "AR5b5YFz2g4W5fYrjbeakPiI3/XxarATSeP+KLh+0FGwkw=="
					}}}
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `Itsxaa\nBy ${ownername}`, orderTitle: 'Itsxaaa', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        ...
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`${creator}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `Itsxaa\nBy ${ownername}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
...
let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`))  
let fil = vote.map(v => v.participant)
let id_vote = sender ? sender : '6289652300145@s.whatsapp.net'
if(fil.includes(id_vote)) {
...
break
		...
		var value = args.join(' ')
				...
				case 'belipremium': case 'buypremium': case 'sewabot': case 'goprem':
							let sewalak = await getBuffer('https://i.ibb.co/VvTj0rT/IMG-20220112-012839.jpg')
				...
				case 'gcbot': case 'grupbot': case 'groupbot':
							let gcbot = await getBuffer('https://i.ibb.co/VvTj0rT/IMG-20220112-012839.jpg')
							...
							break
				case 'infobot':
				let infobopot = await getBuffer('https://i.ibb.co/VvTj0rT/IMG-20220112-012839.jpg')
